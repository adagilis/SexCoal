...
typedef boost::variate_generator<boost::mt19937&, boost::bernoulli_distribution<> > rng_bernoulli_t;
typedef boost::variate_generator<boost::mt19937&, boost::poisson_distribution<> > rng_poisson_t;
...
inline rng_bernoulli_t::result_type randbern(double prob)
{
    //
    // Returns a random deviate from an exponential distribution with parameter lambda
    //
    return make_gen(gen, boost::bernoulli_distribution<>(prob))();
}

inline rng_poisson_t::result_type randpoisson(double lambda)
{
    //
    // Returns a random deviate from an exponential distribution with parameter lambda
    //
